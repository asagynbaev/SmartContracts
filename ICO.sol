...
contract CrowdSale is ReentrancyGuard, Context, Ownable {
    ...
    //Start Pre-Sale
    function startICO() public onlyOwner icoNotActive() {
    ...
    function _getTokensBack() external onlyOwner icoNotActive {
        _token.transfer(_wallet, availableTokensICO);
    }
